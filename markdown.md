...
Чтобы дерево было красивым, стоило сначала добавить коммит в master, а потом уже делать коммит в новой ветке. Теперь, чтобы древо выглядило презентабельно, надо мне надо будет сделать ещё хотя бы один коммит.
***
## Экранирование
