...
***
## Изображения
Сначала не разобрался с коммитами и случился фаст-форвард. Потом увиждел, что после удаления ветки, удаляется и всякое упоминание о ней, остаётся только линия графа, что не очень круто для обучения.